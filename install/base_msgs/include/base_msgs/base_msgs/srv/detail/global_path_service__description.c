  ...
  const rosidl_service_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x8a, 0x44, 0x2f, 0xdb, 0xb0, 0x7c, 0x66, 0xc0,
      0xb0, 0x52, 0x4c, 0xc2, 0x81, 0xbd, 0xf0, 0x10,
      0x3e, 0x0a, 0x60, 0x05, 0x37, 0xa8, 0x4a, 0x09,
      0x11, 0x54, 0x07, 0xc6, 0xcd, 0x79, 0x7c, 0x2f,
    }};
  return &hash;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static rosidl_type_hash_t hash = {1, {
      0x3a, 0xae, 0x45, 0xb5, 0x73, 0xe8, 0xc4, 0x62,
      0x34, 0xf1, 0x72, 0x42, 0x58, 0x20, 0x17, 0x85,
      0x06, 0x7d, 0x06, 0x49, 0x46, 0xb1, 0x9b, 0x4c,
      0xa5, 0x88, 0x20, 0x66, 0x2a, 0x3a, 0x7d, 0xc2,
    }};
  return &hash;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static rosidl_type_hash_t hash = {1, {
      0x1d, 0xfb, 0x4d, 0x38, 0x4a, 0x8a, 0x3d, 0x81,
      0x0a, 0xf6, 0xe9, 0x7a, 0xa0, 0xf9, 0xfb, 0xa1,
      0xfe, 0x34, 0x48, 0x8f, 0x8a, 0x2c, 0x26, 0x28,
      0x5c, 0x6f, 0x25, 0x67, 0x71, 0x1c, 0x5f, 0x64,
    }};
  return &hash;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static rosidl_type_hash_t hash = {1, {
      0xb4, 0x91, 0x04, 0xa3, 0x46, 0x14, 0xe1, 0x2d,
      0x11, 0xc9, 0x82, 0xd0, 0xce, 0xaf, 0x48, 0x5d,
      0x80, 0x18, 0x4b, 0xf5, 0x2b, 0xf1, 0x17, 0x3f,
      0x66, 0x98, 0xfa, 0x1a, 0x58, 0x8f, 0xdb, 0xd9,
    }};
  return &hash;
}
...
#ifndef NDEBUG
static const rosidl_type_hash_t base_msgs__msg__PNCMap__EXPECTED_HASH = {1, {
    0x98, 0x62, 0x28, 0x6c, 0x77, 0x1e, 0x13, 0xad,
    0x3c, 0x23, 0x02, 0x72, 0x7c, 0xe5, 0xfe, 0x95,
    0x84, 0xe7, 0xfe, 0x77, 0x7c, 0x11, 0xce, 0x86,
    0xb3, 0x87, 0xa6, 0xdd, 0x90, 0x44, 0x3d, 0xa6,
  }};
...
static char base_msgs__srv__GlobalPathService__TYPE_NAME[] = "base_msgs/srv/GlobalPathService";
static char base_msgs__msg__PNCMap__TYPE_NAME[] = "base_msgs/msg/PNCMap";
static char base_msgs__srv__GlobalPathService_Event__TYPE_NAME[] = "base_msgs/srv/GlobalPathService_Event";
static char base_msgs__srv__GlobalPathService_Request__TYPE_NAME[] = "base_msgs/srv/GlobalPathService_Request";
static char base_msgs__srv__GlobalPathService_Response__TYPE_NAME[] = "base_msgs/srv/GlobalPathService_Response";
...
static char base_msgs__srv__GlobalPathService__FIELD_NAME__request_message[] = "request_message";
static char base_msgs__srv__GlobalPathService__FIELD_NAME__response_message[] = "response_message";
static char base_msgs__srv__GlobalPathService__FIELD_NAME__event_message[] = "event_message";

static rosidl_runtime_c__type_description__Field base_msgs__srv__GlobalPathService__FIELDS[] = {
  {
    {base_msgs__srv__GlobalPathService__FIELD_NAME__request_message, 15, 15},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
      {base_msgs__srv__GlobalPathService_Request__TYPE_NAME, 39, 39},
    },
    {NULL, 0, 0},
  },
  {
    {base_msgs__srv__GlobalPathService__FIELD_NAME__response_message, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
      {base_msgs__srv__GlobalPathService_Response__TYPE_NAME, 40, 40},
    },
    {NULL, 0, 0},
  },
  {
    {base_msgs__srv__GlobalPathService__FIELD_NAME__event_message, 13, 13},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
      {base_msgs__srv__GlobalPathService_Event__TYPE_NAME, 37, 37},
    },
    {NULL, 0, 0},
  },
};

static rosidl_runtime_c__type_description__IndividualTypeDescription base_msgs__srv__GlobalPathService__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {base_msgs__msg__PNCMap__TYPE_NAME, 20, 20},
    {NULL, 0, 0},
  },
  {
    {base_msgs__srv__GlobalPathService_Event__TYPE_NAME, 37, 37},
  ...
  const rosidl_service_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {base_msgs__srv__GlobalPathService__TYPE_NAME, 31, 31},
      {base_msgs__srv__GlobalPathService__FIELDS, 3, 3},
    },
    {base_msgs__srv__GlobalPathService__REFERENCED_TYPE_DESCRIPTIONS, 19, 19},
  };
  if (!constructed) {
    assert(0 == memcmp(&base_msgs__msg__PNCMap__EXPECTED_HASH, base_msgs__msg__PNCMap__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[0].fields = base_msgs__msg__PNCMap__get_type_description(NULL)->type_description.fields;
    description.referenced_type_descriptions.data[1].fields = base_msgs__srv__GlobalPathService_Event__get_type_description(NULL)->type_description.fields;
    description.referenced_type_descriptions.data[2].fields = base_msgs__srv__GlobalPathService_Request__get_type_description(NULL)->type_description.fields;
    description.referenced_type_descriptions.data[3].fields = base_msgs__srv__GlobalPathService_Response__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&builtin_interfaces__msg__Duration__EXPECTED_HASH, builtin_interfaces__msg__Duration__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[4].fields = builtin_interfaces__msg__Duration__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[12].fields = sensor_msgs__msg__CompressedImage__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[14].fields = std_msgs__msg__ColorRGBA__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[16].fields = visualization_msgs__msg__Marker__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[17].fields = visualization_msgs__msg__MeshFile__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[18].fields = visualization_msgs__msg__UVCoordinate__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
// Define type names, field names, and default values
static char base_msgs__srv__GlobalPathService_Request__FIELD_NAME__global_planner_type[] = "global_planner_type";
static char base_msgs__srv__GlobalPathService_Request__FIELD_NAME__pnc_map[] = "pnc_map";

static rosidl_runtime_c__type_description__Field base_msgs__srv__GlobalPathService_Request__FIELDS[] = {
  {
    {base_msgs__srv__GlobalPathService_Request__FIELD_NAME__global_planner_type, 19, 19},
    {
  ...
  {
    {base_msgs__srv__GlobalPathService_Request__FIELD_NAME__pnc_map, 7, 7},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription base_msgs__srv__GlobalPathService_Request__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {base_msgs__msg__PNCMap__TYPE_NAME, 20, 20},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {base_msgs__srv__GlobalPathService_Request__TYPE_NAME, 39, 39},
      {base_msgs__srv__GlobalPathService_Request__FIELDS, 2, 2},
    },
    {base_msgs__srv__GlobalPathService_Request__REFERENCED_TYPE_DESCRIPTIONS, 13, 13},
  };
  if (!constructed) {
    assert(0 == memcmp(&base_msgs__msg__PNCMap__EXPECTED_HASH, base_msgs__msg__PNCMap__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[0].fields = base_msgs__msg__PNCMap__get_type_description(NULL)->type_description.fields;
...
// Define type names, field names, and default values
static char base_msgs__srv__GlobalPathService_Response__FIELD_NAME__global_path[] = "global_path";

static rosidl_runtime_c__type_description__Field base_msgs__srv__GlobalPathService_Response__FIELDS[] = {
  {
    {base_msgs__srv__GlobalPathService_Response__FIELD_NAME__global_path, 11, 11},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription base_msgs__srv__GlobalPathService_Response__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {builtin_interfaces__msg__Time__TYPE_NAME, 27, 27},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {base_msgs__srv__GlobalPathService_Response__TYPE_NAME, 40, 40},
      {base_msgs__srv__GlobalPathService_Response__FIELDS, 1, 1},
    },
    {base_msgs__srv__GlobalPathService_Response__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
    assert(0 == memcmp(&builtin_interfaces__msg__Time__EXPECTED_HASH, builtin_interfaces__msg__Time__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
...
// Define type names, field names, and default values
static char base_msgs__srv__GlobalPathService_Event__FIELD_NAME__info[] = "info";
static char base_msgs__srv__GlobalPathService_Event__FIELD_NAME__request[] = "request";
static char base_msgs__srv__GlobalPathService_Event__FIELD_NAME__response[] = "response";

static rosidl_runtime_c__type_description__Field base_msgs__srv__GlobalPathService_Event__FIELDS[] = {
  {
    {base_msgs__srv__GlobalPathService_Event__FIELD_NAME__info, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {base_msgs__srv__GlobalPathService_Event__FIELD_NAME__request, 7, 7},
    {
  ...
  {
    {base_msgs__srv__GlobalPathService_Event__FIELD_NAME__response, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_BOUNDED_SEQUENCE,
      1,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription base_msgs__srv__GlobalPathService_Event__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {base_msgs__msg__PNCMap__TYPE_NAME, 20, 20},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {base_msgs__srv__GlobalPathService_Event__TYPE_NAME, 37, 37},
      {base_msgs__srv__GlobalPathService_Event__FIELDS, 3, 3},
    },
    {base_msgs__srv__GlobalPathService_Event__REFERENCED_TYPE_DESCRIPTIONS, 18, 18},
  };
  if (!constructed) {
    assert(0 == memcmp(&base_msgs__msg__PNCMap__EXPECTED_HASH, base_msgs__msg__PNCMap__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[0].fields = base_msgs__msg__PNCMap__get_type_description(NULL)->type_description.fields;
    description.referenced_type_descriptions.data[1].fields = base_msgs__srv__GlobalPathService_Request__get_type_description(NULL)->type_description.fields;
    description.referenced_type_descriptions.data[2].fields = base_msgs__srv__GlobalPathService_Response__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&builtin_interfaces__msg__Duration__EXPECTED_HASH, builtin_interfaces__msg__Duration__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[3].fields = builtin_interfaces__msg__Duration__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&builtin_interfaces__msg__Time__EXPECTED_HASH, builtin_interfaces__msg__Time__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    ...
    assert(0 == memcmp(&sensor_msgs__msg__CompressedImage__EXPECTED_HASH, sensor_msgs__msg__CompressedImage__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[11].fields = sensor_msgs__msg__CompressedImage__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&service_msgs__msg__ServiceEventInfo__EXPECTED_HASH, service_msgs__msg__ServiceEventInfo__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    ...
    assert(0 == memcmp(&std_msgs__msg__ColorRGBA__EXPECTED_HASH, std_msgs__msg__ColorRGBA__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[13].fields = std_msgs__msg__ColorRGBA__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&std_msgs__msg__Header__EXPECTED_HASH, std_msgs__msg__Header__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    ...
    assert(0 == memcmp(&visualization_msgs__msg__Marker__EXPECTED_HASH, visualization_msgs__msg__Marker__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[15].fields = visualization_msgs__msg__Marker__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&visualization_msgs__msg__MeshFile__EXPECTED_HASH, visualization_msgs__msg__MeshFile__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[16].fields = visualization_msgs__msg__MeshFile__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&visualization_msgs__msg__UVCoordinate__EXPECTED_HASH, visualization_msgs__msg__UVCoordinate__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[17].fields = visualization_msgs__msg__UVCoordinate__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
static char toplevel_type_raw_source[] =
  "# \\xe5\\x85\\xa8\\xe5\\xb1\\x80\\xe8\\xa7\\x84\\xe5\\x88\\x92\\xe6\\x9c\\x8d\\xe5\\x8a\\xa1\n"
  "\n"
  "int32 global_planner_type   # \\xe8\\xaf\\xb7\\xe6\\xb1\\x821: \\xe5\\x85\\xa8\\xe5\\xb1\\x80\\xe8\\xa7\\x84\\xe5\\x88\\x92\\xe7\\xb1\\xbb\\xe5\\x9e\\x8b\n"
  "PNCMap pnc_map              # \\xe8\\xaf\\xb7\\xe6\\xb1\\x822: \\xe5\\x9c\\xb0\\xe5\\x9b\\xbe\n"
  "---\n"
  "nav_msgs/Path global_path   # \\xe5\\x93\\x8d\\xe5\\xba\\x94: \\xe5\\x85\\xa8\\xe5\\xb1\\x80\\xe8\\xb7\\xaf\\xe5\\xbe\\x84";
...
base_msgs__srv__GlobalPathService__get_individual_type_description_source(
  const rosidl_service_type_support_t * type_support)
{
  (void)type_support;
...
const rosidl_runtime_c__type_description__TypeSource *
base_msgs__srv__GlobalPathService_Request__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
...
const rosidl_runtime_c__type_description__TypeSource *
base_msgs__srv__GlobalPathService_Response__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
...
const rosidl_runtime_c__type_description__TypeSource *
base_msgs__srv__GlobalPathService_Event__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
  ...
  const rosidl_service_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *base_msgs__srv__GlobalPathService__get_individual_type_description_source(NULL),
    sources[1] = *base_msgs__msg__PNCMap__get_individual_type_description_source(NULL);
    sources[2] = *base_msgs__srv__GlobalPathService_Event__get_individual_type_description_source(NULL);
    sources[3] = *base_msgs__srv__GlobalPathService_Request__get_individual_type_description_source(NULL);
    sources[4] = *base_msgs__srv__GlobalPathService_Response__get_individual_type_description_source(NULL);
    sources[5] = *builtin_interfaces__msg__Duration__get_individual_type_description_source(NULL);
    ...
    sources[13] = *sensor_msgs__msg__CompressedImage__get_individual_type_description_source(NULL);
    sources[14] = *service_msgs__msg__ServiceEventInfo__get_individual_type_description_source(NULL);
    sources[15] = *std_msgs__msg__ColorRGBA__get_individual_type_description_source(NULL);
    sources[16] = *std_msgs__msg__Header__get_individual_type_description_source(NULL);
    sources[17] = *visualization_msgs__msg__Marker__get_individual_type_description_source(NULL);
    sources[18] = *visualization_msgs__msg__MeshFile__get_individual_type_description_source(NULL);
    sources[19] = *visualization_msgs__msg__UVCoordinate__get_individual_type_description_source(NULL);
    constructed = true;
  }
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *base_msgs__srv__GlobalPathService_Request__get_individual_type_description_source(NULL),
    sources[1] = *base_msgs__msg__PNCMap__get_individual_type_description_source(NULL);
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *base_msgs__srv__GlobalPathService_Response__get_individual_type_description_source(NULL),
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *base_msgs__srv__GlobalPathService_Event__get_individual_type_description_source(NULL),
    sources[1] = *base_msgs__msg__PNCMap__get_individual_type_description_source(NULL);
    sources[2] = *base_msgs__srv__GlobalPathService_Request__get_individual_type_description_source(NULL);
    sources[3] = *base_msgs__srv__GlobalPathService_Response__get_individual_type_description_source(NULL);
    sources[4] = *builtin_interfaces__msg__Duration__get_individual_type_description_source(NULL);
    ...
    sources[12] = *sensor_msgs__msg__CompressedImage__get_individual_type_description_source(NULL);
    sources[13] = *service_msgs__msg__ServiceEventInfo__get_individual_type_description_source(NULL);
    sources[14] = *std_msgs__msg__ColorRGBA__get_individual_type_description_source(NULL);
    sources[15] = *std_msgs__msg__Header__get_individual_type_description_source(NULL);
    sources[16] = *visualization_msgs__msg__Marker__get_individual_type_description_source(NULL);
    sources[17] = *visualization_msgs__msg__MeshFile__get_individual_type_description_source(NULL);
    sources[18] = *visualization_msgs__msg__UVCoordinate__get_individual_type_description_source(NULL);
    constructed = true;
  }
  return &source_sequence;
}
