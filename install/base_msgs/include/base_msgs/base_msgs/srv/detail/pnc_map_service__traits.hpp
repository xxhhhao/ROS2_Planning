...
inline std::string to_yaml(const PNCMapService_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use base_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const base_msgs::srv::PNCMapService_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  base_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use base_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const base_msgs::srv::PNCMapService_Event & msg)
{
  return base_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<base_msgs::srv::PNCMapService_Event>()
{
  return "base_msgs::srv::PNCMapService_Event";
}

template<>
inline const char * name<base_msgs::srv::PNCMapService_Event>()
{
  return "base_msgs/srv/PNCMapService_Event";
}

template<>
struct has_fixed_size<base_msgs::srv::PNCMapService_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<base_msgs::srv::PNCMapService_Event>
  : std::integral_constant<bool, has_bounded_size<base_msgs::srv::PNCMapService_Request>::value && has_bounded_size<base_msgs::srv::PNCMapService_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<base_msgs::srv::PNCMapService_Event>
  : std::true_type {};
