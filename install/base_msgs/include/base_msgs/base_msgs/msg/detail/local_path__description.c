  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xb0, 0xa7, 0x5d, 0xd5, 0xdb, 0xbf, 0xbb, 0xaa,
      0xe9, 0x32, 0x7e, 0x12, 0xe1, 0x3f, 0xe5, 0x68,
      0xb4, 0x5f, 0xd8, 0xf3, 0x5b, 0x8b, 0xf4, 0x55,
      0x30, 0x26, 0x3f, 0x88, 0xe5, 0x5f, 0x79, 0x32,
    }};
  return &hash;
}
...
static char base_msgs__msg__LocalPath__TYPE_NAME[] = "base_msgs/msg/LocalPath";
...
static char base_msgs__msg__LocalPath__FIELD_NAME__header[] = "header";
static char base_msgs__msg__LocalPath__FIELD_NAME__local_path[] = "local_path";

static rosidl_runtime_c__type_description__Field base_msgs__msg__LocalPath__FIELDS[] = {
  {
    {base_msgs__msg__LocalPath__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {base_msgs__msg__LocalPath__FIELD_NAME__local_path, 10, 10},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription base_msgs__msg__LocalPath__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {base_msgs__msg__LocalPathPoint__TYPE_NAME, 28, 28},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {base_msgs__msg__LocalPath__TYPE_NAME, 23, 23},
      {base_msgs__msg__LocalPath__FIELDS, 2, 2},
    },
    {base_msgs__msg__LocalPath__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
...
static char toplevel_type_raw_source[] =
  ...
  "LocalPathPoint[] local_path # \\xe8\\xb7\\xaf\\xe5\\xbe\\x84";
...
base_msgs__msg__LocalPath__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *base_msgs__msg__LocalPath__get_individual_type_description_source(NULL),
