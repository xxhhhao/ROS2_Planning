...
static char base_msgs__msg__LocalTrajectory__FIELD_NAME__header[] = "header";
static char base_msgs__msg__LocalTrajectory__FIELD_NAME__local_trajectory[] = "local_trajectory";

static rosidl_runtime_c__type_description__Field base_msgs__msg__LocalTrajectory__FIELDS[] = {
  {
    {base_msgs__msg__LocalTrajectory__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {base_msgs__msg__LocalTrajectory__FIELD_NAME__local_trajectory, 16, 16},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription base_msgs__msg__LocalTrajectory__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {base_msgs__msg__LocalTrajectory__FIELDS, 2, 2},
    },
    {base_msgs__msg__LocalTrajectory__REFERENCED_TYPE_DESCRIPTIONS, 9, 9},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[2].fields = base_msgs__msg__LocalTrajectoryPoint__get_type_description(NULL)->type_description.fields;
...
static char toplevel_type_raw_source[] =
  ...
  "LocalTrajectoryPoint[] local_trajectory # \\xe8\\xbd\\xa8\\xe8\\xbf\\xb9";
...
base_msgs__msg__LocalTrajectory__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *base_msgs__msg__LocalTrajectory__get_individual_type_description_source(NULL),
    ...
    sources[3] = *base_msgs__msg__LocalTrajectoryPoint__get_individual_type_description_source(NULL);
