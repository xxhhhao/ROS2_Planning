...
static char base_msgs__msg__LocalTrajectoryPoint__FIELD_NAME__path_point[] = "path_point";
static char base_msgs__msg__LocalTrajectoryPoint__FIELD_NAME__speed_point[] = "speed_point";

static rosidl_runtime_c__type_description__Field base_msgs__msg__LocalTrajectoryPoint__FIELDS[] = {
  {
    {base_msgs__msg__LocalTrajectoryPoint__FIELD_NAME__path_point, 10, 10},
    {
  ...
  {
    {base_msgs__msg__LocalTrajectoryPoint__FIELD_NAME__speed_point, 11, 11},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription base_msgs__msg__LocalTrajectoryPoint__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {base_msgs__msg__LocalPathPoint__TYPE_NAME, 28, 28},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {base_msgs__msg__LocalTrajectoryPoint__FIELDS, 2, 2},
    },
    {base_msgs__msg__LocalTrajectoryPoint__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
...
static char toplevel_type_raw_source[] =
  "# \\xe8\\xbd\\xa8\\xe8\\xbf\\xb9\\xe7\\x82\\xb9\n"
  "\n"
  "LocalPathPoint path_point     # \\xe8\\xb7\\xaf\\xe5\\xbe\\x84\\xe7\\x82\\xb9\n"
  "LocalSpeedsPoint speed_point  # \\xe9\\x80\\x9f\\xe5\\xba\\xa6\\xe7\\x82\\xb9";
...
base_msgs__msg__LocalTrajectoryPoint__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *base_msgs__msg__LocalTrajectoryPoint__get_individual_type_description_source(NULL),
