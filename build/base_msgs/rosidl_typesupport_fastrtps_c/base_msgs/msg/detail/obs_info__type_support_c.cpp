  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const base_msgs__msg__ObsInfo * ros_message = static_cast<const base_msgs__msg__ObsInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_base_msgs__msg__ObsInfo(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  base_msgs__msg__ObsInfo * ros_message = static_cast<base_msgs__msg__ObsInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_base_msgs__msg__ObsInfo(cdr, ros_message);
}
