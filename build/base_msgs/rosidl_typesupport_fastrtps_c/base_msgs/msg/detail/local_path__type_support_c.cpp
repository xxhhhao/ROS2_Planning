...
#include "base_msgs/msg/detail/local_path__rosidl_typesupport_fastrtps_c.h"
...
#include "base_msgs/msg/detail/local_path_point__functions.h"  // local_path
...
using _LocalPath__ros_msg_type = base_msgs__msg__LocalPath;
  ...
  base_msgs__msg__LocalPath * ros_message)
{
  ...
  // Field name: local_path
  {
    ...
    if (ros_message->local_path.data) {
      base_msgs__msg__LocalPathPoint__Sequence__fini(&ros_message->local_path);
    }
    if (!base_msgs__msg__LocalPathPoint__Sequence__init(&ros_message->local_path, size)) {
      fprintf(stderr, "failed to create array for field 'local_path'");
      return false;
    }
    auto array_ptr = ros_message->local_path.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_base_msgs__msg__LocalPathPoint(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_msgs__msg__LocalPath;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const base_msgs__msg__LocalPath * ros_message = static_cast<const base_msgs__msg__LocalPath *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_base_msgs__msg__LocalPath(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  base_msgs__msg__LocalPath * ros_message = static_cast<base_msgs__msg__LocalPath *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_base_msgs__msg__LocalPath(cdr, ros_message);
}

static uint32_t _LocalPath__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_base_msgs__msg__LocalPath(
...
static size_t _LocalPath__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_msgs__msg__LocalPath(
