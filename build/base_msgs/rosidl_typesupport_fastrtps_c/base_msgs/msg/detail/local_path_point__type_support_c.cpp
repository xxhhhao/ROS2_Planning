...
#include "base_msgs/msg/detail/local_path_point__rosidl_typesupport_fastrtps_c.h"
...
using _LocalPathPoint__ros_msg_type = base_msgs__msg__LocalPathPoint;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_msgs__msg__LocalPathPoint;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const base_msgs__msg__LocalPathPoint * ros_message = static_cast<const base_msgs__msg__LocalPathPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_base_msgs__msg__LocalPathPoint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  base_msgs__msg__LocalPathPoint * ros_message = static_cast<base_msgs__msg__LocalPathPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_base_msgs__msg__LocalPathPoint(cdr, ros_message);
}

static uint32_t _LocalPathPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_base_msgs__msg__LocalPathPoint(
...
static size_t _LocalPathPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_msgs__msg__LocalPathPoint(
