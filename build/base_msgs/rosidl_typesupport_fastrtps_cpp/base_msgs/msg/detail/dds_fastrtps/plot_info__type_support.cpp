  ...
  size_t current_alignment)
{
  ...
  // Member: trajectory_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        base_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_LocalTrajectory(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: obs_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        base_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ObsInfo(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const base_msgs::msg::PlotInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_msgs::msg::PlotInfo *>(
    untyped_ros_message);
...
{
  return &base_msgs::msg::typesupport_fastrtps_cpp::_PlotInfo__handle;
}
