...
#include "base_msgs/msg/detail/referline_point__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_msgs::msg::ReferlinePoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_msgs::msg::ReferlinePoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_msgs::msg::ReferlinePoint *>(
    untyped_ros_message);
...
{
  return &base_msgs::msg::typesupport_fastrtps_cpp::_ReferlinePoint__handle;
}
